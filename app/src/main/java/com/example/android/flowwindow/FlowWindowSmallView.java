...
public class FlowWindowSmallView extends LinearLayout {
    ...
    public FlowWindowSmallView(Context context) {
        super(context);
...
//                        @Override
//                        public void run() {
//                            ((MainActivity)mContext).removeSmallWindow();
//                            ((MainActivity)mContext).createSmallHalfWindow();
//                        }
//                    },3000);
                }
    ...
    private void init() {
        mFlowLayout = LayoutInflater.from(mContext).inflate(R.layout.layout_flow_small_window, this);
